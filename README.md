...
- Created a Vercel preview deployment for the current workspace state.
- Setup PostgreSQL schema (Users, Workflows, Datasets, Configs).
- Build User Registration & Authentication flow.
- Implement API Key generation, validation, and middleware protection.
